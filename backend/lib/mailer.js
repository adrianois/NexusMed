...
// Configura transporter via vari\u00e1veis de ambiente
// Suporta qualquer SMTP: Gmail, Outlook, Mailtrap, Resend, etc.
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:auto;padding:32px;background:#f8fafc;border-radius:12px">
        ...
        <div style="text-align:center;margin:28px 0">
          <a href="${link}"
             style="background:#1d4ed8;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:bold;font-size:1rem">
            Redefinir Senha
          </a>
        </div>
        <p style="color:#64748b;font-size:0.85rem">Se voc\u00ea n\u00e3o solicitou isso, ignore este e-mail.</p>
        <p style="color:#64748b;font-size:0.85rem">Ou copie e cole este link no navegador:<br/>
